...
import { Route as ApiDocumentsMutateRouteImport } from './routes/api/documents.mutate'
...
const ApiDocumentsMutateRoute = ApiDocumentsMutateRouteImport.update({
  id: '/mutate',
  path: '/mutate',
...
export interface FileRoutesByFullPath {
  ...
  '/api/documents/mutate': typeof ApiDocumentsMutateRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api/documents/mutate': {
      id: '/api/documents/mutate'
      path: '/mutate'
      fullPath: '/api/documents/mutate'
      preLoaderRoute: typeof ApiDocumentsMutateRouteImport
...
interface ApiDocumentsRouteChildren {
  ApiDocumentsMutateRoute: typeof ApiDocumentsMutateRoute
}

const ApiDocumentsRouteChildren: ApiDocumentsRouteChildren = {
  ApiDocumentsMutateRoute: ApiDocumentsMutateRoute,
}
